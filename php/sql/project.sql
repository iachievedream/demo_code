...
CREATE TABLE `users` (
  ...
  `work_am_start` time DEFAULT NULL DEFAULT '09:00',
  `work_am_end` time DEFAULT NULL DEFAULT '12:00',
  `work_pm_start` time DEFAULT NULL DEFAULT '13:30',
  `work_pm_end` time DEFAULT NULL DEFAULT '18:00',
